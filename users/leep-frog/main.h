...
#define CK_OSM_EMOJI CK(CK_OSM_EMOJI_HANDLER)
...
#define LK_BASE_LEFT_THUMB_TERTIARY TO_EMOJI
...
#define LK_SCROLL_S MS_WHLL
#define LK_SCROLL_D MS_WHLD
#define LK_SCROLL_F MS_WHLR
#define LK_SCROLL_G _______
#define LK_SCROLL_H _______
#define LK_SCROLL_J MS_WHLL
#define LK_SCROLL_K MS_WHLD
#define LK_SCROLL_L MS_WHLR
...
// LR_EMOJI layer
// Number row
#define LK_EMOJI_ESC _______
#define LK_EMOJI_1 _______
#define LK_EMOJI_2 _______
#define LK_EMOJI_3 _______
#define LK_EMOJI_4 _______
#define LK_EMOJI_5 _______
#define LK_EMOJI_6 _______
#define LK_EMOJI_7 _______
#define LK_EMOJI_8 _______
#define LK_EMOJI_9 _______
#define LK_EMOJI_0 _______
#define LK_EMOJI_MINUS _______
#define LK_EMOJI_EQUAL _______
// Top row
#define LK_EMOJI_TAB _______
#define LK_EMOJI_Q _______
...
#define LK_EMOJI_O _______
#define LK_EMOJI_P _______
#define LK_EMOJI_LBRC _______
#define LK_EMOJI_RBRC _______
// Middle row
#define LK_EMOJI_CAPS_LOCK _______
#define LK_EMOJI_A _______
#define LK_EMOJI_S _______
#define LK_EMOJI_D _______
#define LK_EMOJI_F _______
#define LK_EMOJI_G _______
#define LK_EMOJI_H _______
#define LK_EMOJI_J _______
#define LK_EMOJI_K _______
#define LK_EMOJI_L _______
#define LK_EMOJI_SC _______
#define LK_EMOJI_QUOTE _______
#define LK_EMOJI_ENTER _______
// Bottom row
#define LK_EMOJI_LSFT _______
#define LK_EMOJI_Z _______
#define LK_EMOJI_X _______
#define LK_EMOJI_C _______
#define LK_EMOJI_V _______
#define LK_EMOJI_B _______
#define LK_EMOJI_N _______
#define LK_EMOJI_M _______
#define LK_EMOJI_LT _______
#define LK_EMOJI_GT _______
#define LK_EMOJI_SL _______
#define LK_EMOJI_RSFT _______
// Thumbs
#define LK_EMOJI_LEFT_THUMB_PRIMARY _______
#define LK_EMOJI_LEFT_THUMB_SECONDARY _______
#define LK_EMOJI_LEFT_THUMB_TERTIARY _______
#define LK_EMOJI_RIGHT_THUMB_PRIMARY _______
#define LK_EMOJI_RIGHT_THUMB_SECONDARY _______
#define LK_EMOJI_RIGHT_THUMB_TERTIARY _______
