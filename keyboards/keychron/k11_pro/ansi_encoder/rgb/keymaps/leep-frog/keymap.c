...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LR_ELLA] = LAYOUT_69_ansi(
        ...
        KC_LCTL, KC_LALT,  TO_ALT,           KC_RSFT,          TO_SYMB,     TO_CTRL,       TO_OH_R,            KC_RGUI,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [LR_BASE] = LAYOUT_69_ansi(
        ...
        KC_LCTL, KC_LALT,  TO_ALT,            CK_SHFT,          TO_SYMB,     TO_CTRL,       TO_OH_R,           TO_NAV,             KC_LEFT,  KB_OFF,  KC_RGHT),
