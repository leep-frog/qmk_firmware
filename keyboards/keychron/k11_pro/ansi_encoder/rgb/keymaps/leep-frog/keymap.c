...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LR_ELLA] = LAYOUT_69_ansi(
        ...
        KC_LCTL, KC_LALT,  KC_LGUI,         KC_RSFT,          TO_SYMB,      TO_CTRL,       KC_SPACE,             KC_RGUI,            KC_LEFT, KC_DOWN, KC_RGHT),
...
LSFT_T(CL(LPRN)),KC_HOME,  CL(F),    KC_DEL,  KC_RGHT, CK_CTLG,           KC_BSPC, TGL_SHF, CK_KILL, KC_PGUP,  TO_CTSH, MO(LR_CTRL_SHIFT),CL(ENT),   _______,
    ...
    [LR_CTRL_SHIFT] = LAYOUT_69_ansi(
        ...
        _______, _______,  AL(F4),   _______, _______, CK_ALTT, CK_PSTE,  CK_SATB, CL_SH(I),CK_ATB,  KC_PGUP,  _______,  _______,  _______,         _______,
        _______, _______,  CL_SH(F), CL(DEL), CL(RGHT),_______,           CK_UNBS, CK_TGSH, _______, SH(PGUP), _______,  _______,  _______,  _______,
