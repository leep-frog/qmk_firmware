...
#define LEEP_LAYOUT(PFX, backspace, version, bsls, del, home, up, ctrl, alt, left, down, right) LAYOUT_ansi_69( \
    ...
    ctrl,    alt,    PFX##_LEFT_THUMB_TERTIARY,         PFX##_LEFT_THUMB_PRIMARY,   PFX##_LEFT_THUMB_SECONDARY, PFX##_RIGHT_THUMB_SECONDARY, PFX##_RIGHT_THUMB_PRIMARY,  PFX##_RIGHT_THUMB_TERTIARY,            left, down, right)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LR_ELLA] = LEEP_LAYOUT(LK_ELLA,
        ...
        KC_LCTL, KC_LALT,  KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [LR_BASE] = LEEP_LAYOUT(LK_BASE,
        ...
        /* middle row */ CK_MCR2,
        /* bottom row */ CK_LOCK,
        KC_LCTL, KC_LALT,  KC_LEFT,  KB_OFF,  KC_RGHT),
    ...
    [LR_CTRL] = LEEP_LAYOUT(LK_CTRL,
        ...
        /* middle row */ _______,
        /* bottom row */ CL(UP),
        CL(LCTL),CL(LALT), CL(LEFT),CL(DOWN),CL(RGHT)),
    ...
    [LR_ALT] = LEEP_LAYOUT(LK_ALT,
        ...
        /* middle row */ _______,
        /* bottom row */ AL(UP),
        AL(LCTL),AL(LALT), AL(LEFT),AL(DOWN),AL(RGHT)),
