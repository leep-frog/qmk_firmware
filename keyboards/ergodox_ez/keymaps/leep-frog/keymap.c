...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_LSPO,         LT(MDIA, KC_A), KC_S,          KC_D,    KC_F,    KC_G,                        KC_H,    KC_J,    KC_K,        KC_L,        LT(SYMB, KC_SCLN), KC_RSPC,
...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  _______, KC_QUES, KC_AT,   KC_EXLM, KC_HASH, KC_AT,   _______,   _______, KC_WH_U, KC_TABB, KC_UP,   KC_TABF, KC_ASTR, KC_F12,
...
[MDIA] = LAYOUT_ergodox_pretty(
  ...
  _______, _______, KC_7,    KC_8,    KC_9,    _______, _______,     _______, KC_WH_U, KC_TABB, KC_MS_U, KC_TABF, MY_PSTE, _______,
  _______, _______, KC_4,    KC_5,    KC_6,    _______,                       KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, _______, KC_MPLY,
