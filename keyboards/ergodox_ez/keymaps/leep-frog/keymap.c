...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  LT(SYMB, KC_LBRACKET),     KC_Z,           KC_X,          KC_C,    KC_V,    KC_B,    KC_SPCB,  KC_SPCF,  KC_N,    KC_M,    KC_COMMA,    KC_DOT,      KC_SLSH, LT(SYMB, KC_RBRACKET),
...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  _______, KC_QUES, KC_QUOT, KC_EQL,  KC_CIRC, KC_GRV,  _______,   _______, KC_PIPE, KC_LBRC, KC_RBRC, KC_AT,    KC_PERC, KC_F12,
  _______, KC_AMPR, KC_ASTR, KC_DLR,  KC_SLSH, KC_GT,                       KC_HASH, KC_LPRN, KC_RPRN, KC_LT,    KC_PLUS, _______,
  _______, KC_PERC, KC_EXLM, KC_PERC, KC_CIRC, KC_BSLS, _______,   _______, KC_PLUS, KC_LCBR, KC_RCBR, KC_3,     KC_BSLS, _______,
...
[MDIA] = LAYOUT_ergodox_pretty(
  ...
  _______, _______, KC_7,    KC_8,    KC_9,    _______, _______,     _______, KC_WH_U, KC_TABB, KC_UP,   KC_TABF, MY_PSTE, _______,
  _______, _______, KC_4,    KC_5,    KC_6,    KC_0,                          KC_WH_D, KC_LEFT, KC_DOWN, KC_RIGHT, _______, KC_MPLY,
  _______, _______, KC_1,    KC_2,    KC_3,    _______, _______,     _______, MY_COPY, KC_WWWB, _______, KC_WWWF, _______, _______,
